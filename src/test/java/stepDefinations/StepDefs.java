 ...
 * The StepDefs.Java file is used to implement the feature written into the feature file.
 *
...
public class StepDefs {
	...
	public void user_enters_password_however_do_not_enter_username(String password) throws Throwable {
	...
	public void user_enter_incorrect_username(String username, String password) throws Throwable {
	...
	public void enter_username_to_reset_password(String username) throws Throwable {
		System.out.println("enter username to reset password");
		Thread.sleep(5000);

		loginpg.enterUsernameToResetPassword(username);
	...
	public void click_on_request_a_reset_button() throws Throwable {
		...
		loginpg.clickOnRequestResetButton();
		//driver.findElement(By.xpath("//button[@id='signInSubmitButton']")).click();
		Thread.sleep(5000);
	...
	public void email_sent_popup_should_be_displayed(boolean popup1) throws Throwable {
		System.out.println("Email Sent popup should be displayed");

		boolean popup=  loginpg.validateResetEmailPopup(popup1);
